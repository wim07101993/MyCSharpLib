...
{
    /// <summary>Serializes an object of a given type to xml format.</summary>
    public class XmlSerializer : ISerializerDeserializer
    {
        /// <summary>Extension for the files with the serialized content. (.xml)</summary>
        ...
        /// <summary>Deserializes the a xml-string to type <see cref="T"/>.</summary>
