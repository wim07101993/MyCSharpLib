...
{
    /// <summary>Interface that describes the methods and properties of a file service</summary>
    public interface IFileService
    {
        ...
        /// <summary>Reads the content of a file and parses it to an object.</summary>
        ...
        /// <summary>Reads the encrypted content of a file and parses it to an object.</summary>
        /// <typeparam name="T">Type to parse the content to.</typeparam>
        /// <param name="path">Path to the file to read the json from.</param>
        /// <param name="deserializer">
        ///     Deserializer to deserialize the content of the file. If this parameter is null, the
        ...
        /// <summary>Writes a string encrypted to a file.</summary>
        /// <param name="text">Text to write to the file.</param>
        /// <param name="path">Path to the file to write to.</param>
        /// <param name="cryptoTransform">
        ...
        /// <summary>Writes a list of lines to a file.</summary>
        /// <param name="path">Path to the file to write to.</param>
        /// <param name="lines">Lines to write to the file.</param>
        Task WriteLinesAsync(IEnumerable<string> lines, string path);

        /// <summary>Writes a list of lines encrypted to a file.</summary>
        /// <param name="path">Path to the file to write to.</param>
        /// <param name="lines">Lines to write to the file.</param>
        /// <param name="cryptoTransform">
        ///     Transformer that is use to encrypt the data. If this parameter is null, the property
        ...
        /// <summary>Writes an object, serialized with json, to a file.</summary>
        /// <param name="path">Path to the file to write to.</param>
        ...
        /// <summary>Writes an object, serialized with json, to an encrypted file.</summary>
        /// <param name="path">Path to the file to write to.</param>
        /// <param name="value">Value to write to the file as json</param>
        /// <param name="deserializer">
