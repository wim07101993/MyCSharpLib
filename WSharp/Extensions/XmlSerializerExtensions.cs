...
namespace WSharp.Extensions
{
    ...
    {
        /// <summary>
        ///     Deserializes the content of a <see cref="Stream"/> to an object using xml.
        /// </summary>
        ...
        /// <summary>
        ///     Deserializes the content of a <see cref="TextReader"/> to an object using xml.
        /// </summary>
        /// <typeparam name="T">Type to deserialize the content to.</typeparam>
        /// <param name="serializer">Serializer to deserialize the content of the stream.</param>
        ...
        /// <summary>
        ///     Deserializes the content of a <see cref="XmlReader"/> to an object using xml.
        /// </summary>
        /// <typeparam name="T">Type to deserialize the content to.</typeparam>
        /// <param name="serializer">Serializer to deserialize the content of the stream.</param>
        /// <param name="reader">Reader to deserialize.</param>
        ...
        /// <summary>Serializes an object to a <see cref="Stream"/> using xml.</summary>
        ...
        /// <summary>Serializes an object to a <see cref="TextWriter"/> using xml.</summary>
        /// <param name="serializer">Serializer to serialize the object</param>
        ...
        /// <summary>Serializes an object to a <see cref="XmlWriter"/> using xml.</summary>
        /// <param name="serializer">Serializer to serialize the object</param>
