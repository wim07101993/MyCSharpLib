...
namespace WSharp
{
    /// <inheritdoc/>
    /// <summary>
    /// Abstraction for the <see cref="IValidatable"/> interface. It validates a classes properties
    /// with the <see cref="ObjectExtensions.Validate(object, out List{ValidationException})"/> method.
    /// <para>
    ...
    {
        /// <summary>
        /// Message of the <see cref="AggregateException"/> that is thrown when the <see cref="Validate"/>
        /// method is called an this object is not valid.
        /// </summary>
        ...
        /// <inheritdoc/>
        /// <summary>
        /// This method calles the <see cref="TryValidate(out AggregateException)"/> method to validate
        /// this object.
        /// </summary>
